         ...
         <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
               <ol class="breadcrumb">
                  ...
                  <li class="active">
                     <strong>Update Proud Associates</strong>
                  </li>
               </ol>
            </div>
         </div>
      ...
      <div class="col-lg-12">
         <section class="box ">
            <header class="panel_header">
               <h2 class="title pull-left">Update Proud Associates</h2>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                     <form action="{{ route('manage-feature-logo.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <br><img src="{{ asset('storage/associates-img/' . $feature_logo->img_file) }}" style="width: 100px;">
                           <div class="controls">
