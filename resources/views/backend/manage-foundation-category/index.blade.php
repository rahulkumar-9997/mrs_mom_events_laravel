...
@section('title','Manage Gallery Category')
         ...
         <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
               <ol class="breadcrumb">
                  ...
                  <li class="active">
                     <strong>Manage Gallery Category</strong>
                  </li>
               </ol>
            </div>
         </div>
      ...
      <div class="col-lg-12">
         <section class="box ">
            <header class="panel_header">
               <h2 class="title pull-left">Manage Gallery Category</h2>
               <div class="actions panel_actions pull-right">
                  
                  <a href="javascript:void(0)" data-foundation-category-popup="true" data-size="sm" data-title="Add New Gallery Category" data-url="{{ route('gallery-category.create') }}" data-bs-toggle="tooltip" class="btn btn-warning btn-sm" data-bs-original-title="Add New Gallery Category">
