         ...
         <div class="page-title">
            ...
            <div class="pull-right hidden-xs">
               <ol class="breadcrumb">
                  ...
                  <li class="active">
                     <strong>Manage Foundation Image</strong>
                  </li>
               </ol>
            </div>
         </div>
      ...
      <div class="col-lg-12">
         <section class="box ">
            <header class="panel_header">
               <h2 class="title pull-left">Manage Foundation Image</h2>
               <div class="actions panel_actions pull-right">
                  
                  <a href="javascript:void(0)" data-foundation-category-popup="true" data-size="sm" data-title="Add New Foundation Category" data-url="{{ route('gallery-category.create') }}" data-bs-toggle="tooltip" class="btn btn-warning btn-sm" data-bs-original-title="Add New Foundation Category">
